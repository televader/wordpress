...
class Thim_Ekit_Widget_Link extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'title_tag',
			array(
				'label'     => __( 'Title HTML Tag', 'thim-elementorkits' ),
	...
	protected function _register_style_title() {
		$this->start_controls_section(
			'section_style_link',
			[
				'label' => esc_html__( 'Title', 'thim-elementorkits' ),
		...
		$this->add_control(
			'text-color-hover',
			[
				'label'     => esc_html__( 'Color Hover', 'thim-elementorkits' ),
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
	...
	protected function _register_style_desc() {
		$this->start_controls_section(
			'section_style_desc',
			[
				'label' => esc_html__( 'Content', 'thim-elementorkits' ),
				'tab'   => Controls_Manager::TAB_STYLE,
				'condition'        => [
					'content!' => ''
				]
