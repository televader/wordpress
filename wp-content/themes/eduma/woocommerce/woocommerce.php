...
add_filter( 'woocommerce_output_related_products_args', 'thim_related_products_args', 20 );
  function thim_related_products_args( $args ) {
	global   $theme_options_data;
 	// thim_woo_product_column
	$args['posts_per_page'] = $theme_options_data['thim_woo_product_column']; // 4 related products
	$args['columns'] = $theme_options_data['thim_woo_product_column']; // arranged in 2 columns
	return $args;
}
...
function thim_upsell_products_coulmn( $args){
	global   $theme_options_data;
     $args['columns'] = $theme_options_data['thim_woo_product_column']; 
   return $args;
} 