...
if ( ! function_exists( 'thim_course_offline_unregister_post_type' ) ) {
	function thim_course_offline_unregister_post_type() {
		// unregister_post_type( LP_LESSON_CPT );
		// unregister_post_type( LP_QUESTION_CPT );
		// unregister_post_type( LP_QUIZ_CPT );
...
if ( ! function_exists( 'thim_course_offline_remove_learnpress_hooks' ) ) {
	function thim_course_offline_remove_learnpress_hooks() {
		remove_action( 'thim_single_course_payment', LP()->template( 'course' )->func( 'course_pricing' ), 5 );
		remove_action( 'thim_single_course_payment', LP()->template( 'course' )->func( 'course_buttons' ), 15 );
...
add_action( 'learn-press/course-content-summary', LP()->template( 'course' )->callback( 'single-course/tabs/overview' ), 15 );
