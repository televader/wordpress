...
class Thim_Kirki_Extended extends Thim_Singleton {
	...
	public function autoload( $class_name ) {
		switch ( $class_name ) {
			...
			case 'TP_Kirki_Controls_Notice_Control':
				include_once THIM_CORE_INC_PATH . '/kirki-extended/controls/class-thim-kirki-control-notice.php';
				break;
...
//			'900italic',
	...
	public function add_accordion_control( $controls ) {
		...
		$controls['tp_notice'] = 'TP_Kirki_Controls_Notice_Control';
		return $controls;
	}
}