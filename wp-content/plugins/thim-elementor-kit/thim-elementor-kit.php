...
define( 'THIM_EKIT_VERSION', '1.0.6' );
...
define( 'THIM_EKIT_PLUGIN_BASE', plugin_basename( __FILE__ ) );
...
function thim_el_kit() {
	return Thim_EL_Kit::instance();
}

// If Multilsite.
if ( function_exists( 'is_multisite' ) && is_multisite() ) {
	add_action( 'plugins_loaded', 'thim_el_kit', 90 );
} else {
	thim_el_kit();
}
