...
class Thim_Ekit_Widget_Breadcrumb extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Thim Breadcrumb', 'thim-elementor-kit' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .thim-ekit-breadcrumb  > .thim-ekit-breadcrumb __delimiter' => 'color: {{VALUE}}',
				),
			)
		);
		...
		if ( ! empty( $breadcrumb ) ) {
			...
			foreach ( $breadcrumb as $key => $crumb ) {
				...
				if ( sizeof( $breadcrumb ) !== $key + 1 ) {
					echo '<span class="thim-ekit-breadcrumb __delimiter">' . esc_html( $delimiter ) . '</span>';
				}
			}
			?>
