...
class Thim_Ekit_Widget_Product_Rating extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Thim Product Rating', 'thim-elementor-kit' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .thim-ekit-single-product__rating .star-rating' => 'color: {{VALUE}}',
				),
			)
		);
	...
	public function render() {
		...
		<div class="thim-ekit-single-product__rating">
