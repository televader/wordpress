...
class Thim_Ekit_Widget_Product_Price extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Thim Product Price', 'thim-elementor-kit' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .thim-ekit-single-product__price .price' => 'color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				'name'     => 'typography',
				'selector' => '{{WRAPPER}} .thim-ekit-single-product__price .price',
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .thim-ekit-single-product__price .price ins' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_group_control(
			...
			array(
				...
				'selector' => '{{WRAPPER}} .thim-ekit-single-product__price .price ins',
			)
		);
	...
	public function render() {
		...
		<div class="thim-ekit-single-product__price">
